...
using static BlackZero.SDK.Memory;
using System.Threading;
using static BlackZero.SDK.Offsets;
using BlackZero.SDK;
using static BlackZero.SDK.Structs.GlowObject;
using BlackZero.SDK.Structs;
...
namespace BlackZero
{
    public partial class Form1 : Form
    {
        ...
        public void Init()
        {
            ...
            {
                MessageBox.Show("Start csgo.exe!", "BlackZero", MessageBoxButtons.OK);
                Environment.Exit(1);
            }
